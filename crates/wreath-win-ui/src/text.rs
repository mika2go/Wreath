...
pub struct Strings {
    ...
    pub tray_elevated_enable: &'static str,
    pub tray_elevated_disable: &'static str,
    pub tray_elevated_blocks_autostart: &'static str,
...
pub const GERMAN: Strings = Strings {
    ...
    tray_elevated_enable: "Mit Administratorrechten starten",
    tray_elevated_disable: "Ohne Administratorrechte starten",
    tray_elevated_blocks_autostart: "Der Autostart läuft mit Administratorrechten; dort umschalten.",
...
pub const ENGLISH: Strings = Strings {
    ...
    tray_elevated_enable: "Start with administrator rights",
    tray_elevated_disable: "Start without administrator rights",
    tray_elevated_blocks_autostart: "Autostart runs with administrator rights; change it there.",
